...
export type OrnamentStyle='scroll-cross'|'diamond-scroll'|'ring-panel'|'heart-scroll'|'double-s'|'spear-scroll'|'basket'|'leaf-panel'|'lyre'|'spiral-branch'|'spearhead'|'basket-piece'|'c-scroll'|'s-scroll';
